...
export const socialMediaButtonsDataHalloween: { colour: string; link?: string }[] = [
  {
    colour: "LinkedIn",
...
export const DiscogsSvgIcon = () => {
  return (
    <svg
      className="dark:fill-white fill-black hover:fill-white"
...
export default function SocialMediaButtonHalloween({
  link,
  colour,
}: {
  link?: string;
            ...
            <Fragment>
              ...
              >
                ...
                >
                  <div>
                    My Discord is{" "}
                    <code className="dark:bg-zinc-800 dark:text-gray-50 bg-gray-200">
                      banner.
                    </code>
                  </div>
                </Popover.Panel>
          ...
          className={`
                    ...
                    ${
                      colour === "GitHub"
                        ...
                        : colour === "LinkedIn"
                          ? "hover:bg-LinkedIn dark:hover:bg-LinkedIn"
                          : colour === "Discord"
                            ? "hover:bg-Discord dark:hover:bg-Discord"
                            : colour === "Discogs"
